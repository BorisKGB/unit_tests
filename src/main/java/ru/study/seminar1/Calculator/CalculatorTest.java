package ru.study.seminar1.Calculator;

import ru.study.seminar1.Calculator.Calculator;
...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        // assertThatThrownBy(() ->
        //         ru.study.seminar1.Calculator.Calculator.squareRootExtraction(0, 1, -1)
        ...
        // assertThatThrownBy(() ->
        //        ru.study.seminar1.Calculator.Calculator.calculation(5, 0, '/')
        ...
        // if (0 != ru.study.seminar1.Calculator.Calculator.calculation(2, 6, '+')) {
        //     throw new AssertionError("Ошибка в методе");
        // }
